...
public class DetailsActivity extends AppCompatActivity {
    ...
    private static com.doxua.www.faceinternaldbr3.MainActivity instance;
    ...
    protected void onStart() {
        ...
        public void notifications(){
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(DetailsActivity.this)
        ...
        void detectDisplayAndRecognize(Bitmap bitmap) {
            ...
            faceDetector = TrainFaces.loadClassifierCascade(DetailsActivity.this, R.raw.frontalface);
            // Detect the face.
